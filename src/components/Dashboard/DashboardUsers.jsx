        ...
        <>
            <section className="relative bg-bgFah h-screen">
                    ...
                    <div className="flex items-center gap-[.5vw]">
                        ...
                        <div className="flex items-center gap-[1vw] border-[.1vw] border-borderuser w-auto rounded-[2vw] px-[1vw]">
                            ...
                            <div>
                                ...
                                <span className="badge md:badge-lg lg:badge-xs badge-xs badge-warning">Admin</span>
                            </div>
                ...
                <div className="  ml-[25vw] md:top-[12vw] top-[18vw] absolute lg:relative lg:top-[-3.5vw] right-[88vw] lg:right-[7vw] h-8 lg:w-[20vw]">
                    <input type="search" className="lg:w-[20vw] lg:h-8 md:text-xl md:h-16 ml-[25vw] absolute bg-navbar w-[60vw]  text-bgFah h-8 text-base lg:text-[1vw] bg-[#0f1520]! border-[.1vw]! rounded-xl border-[#ffffff60]! pr-[.5vw]!" placeholder="Rechecher un utilisateur..." onChange={(e) => handleSearch(e.target.value)} />
