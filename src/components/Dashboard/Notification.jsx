            ...
            <div className="dropdown dropdown-end " onClick={clearStorage}>
                ...
                <div className="dropdown-content menu bg-[#FFFF]! rounded-box z-1 w-52 p-2">
                    {commandNotif.Total > 0 || CountNewUser > 0 ? (
                        <>
                            <span className="text-[.9vw] text-[#121127]">il y a {commandNotif.Total} {commandNotif.Total > 1 ? "nouvelles commandes" : "nouvelle commande"}
                            </span>
                            <span className="text-[.9vw] text-[#121127]">il y a {CountNewUser} {CountNewUser > 1 ? "nouveaux utilisateurs" : "nouveau utilisateur"}
                            </span>
                        </>
                    ) : (
                        <>
                            <span className="text-[.9vw] text-[#121127]">Pas de nouvelle commande</span>
                            <span className="text-[.9vw] text-[#121127]">Pas de nouveau utilisateur</span>
                        </>
                    )}
                </div>
                {/* <div className="dropdown-content menu bg-[#FFFF]! rounded-box z-1 w-52 p-2">
